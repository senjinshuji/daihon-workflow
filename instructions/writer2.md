...
### Phase 2: 5つの台本制作
CDからの制作指示に基づき、あなたに与えられた人格ファイルを深く理解し、論理的で説得力のある5つの台本を制作します。
...
*   **人格解釈**: (`writer2_loop[N].md` の人格をどう解釈し、どの方針で制作するか)
*   **訴求方向性の決定**: [価格/権威性/効果] 
    *   *理由*: (なぜこの訴求方向性を選択したか)
*   **WHO-FMT-USP分析**:
    *   **WHO (ターゲット)**: (ターゲットは誰か)
...
echo "writer2_${current_loop}_done" > tmp/writer2_${current_loop}_done.txt
