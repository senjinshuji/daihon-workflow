...
# product_analysis.mdで定義された「ターゲット1」と、target_analysis.mdの深層心理分析を統合し、ペルソナとして具体化する。
...
# product_analysis.mdで定義された「ターゲット2」と、target_analysis.mdの深層心理分析を統合し、ペルソナとして具体化する。
# このペルソナがどのような価値観を持ち、何を重視し、どんな言葉に心を動かされるのかを詳細に記述する。
EOF
...
# product_analysis.mdで定義された「ターゲット3」と、target_analysis.mdの深層心理分析を統合し、ペルソナとして具体化する。
# このペルソナがどのような価値観を持ち、何を重視し、どんな言葉に心を動かされるのかを詳細に記述する。
EOF
