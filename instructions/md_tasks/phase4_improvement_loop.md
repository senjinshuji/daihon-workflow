...
## ${NEXT_LOOP}での改善方針
**重要**: 前ループの評価項目は**変更・削除しません**。改善は**「新規項目の追加（任意、1〜2個まで）」**と**「ペルソナ別評価ウェイトの調整」**によって行います。

- **全ループからの学び**: [統合分析レポートから、評価基準の改善に繋がる発見を要約]
- **今回の改善アクション**: [上記学びに基づき、「新規項目を追加する」「ウェイトを調整する」など、今回行う具体的なアクションを記述]

---

## 評価項目リスト
*前ループの項目はそのまま維持し、必要な場合のみ新規項目を末尾に追加してください。*

### 継続項目
*前回のループから引き継いだ項目。内容は変更しないでください。*
1. **[前ループの項目1]**
2. **[前ループの項目2]**
... (以下、前ループの全項目をそのまま記述)

### 新規追加項目（任意）
*分析に基づき、必要であれば1〜2個まで追加。不要な場合はこのセクションごと削除してください。*
- **[新規項目名1]**
  - **チェックポイント**: [具体的なチェックポイントを記述]
- **[新規項目名2]**
  - **チェックポイント**: [具体的なチェックポイントを記述]
...
*統合分析に基づき、各ペルソナの反応が良かった要素を重点評価するようウェイトを調整します。これが今回の改善の主要な手段の一つです。*
