...
##### FMT（フォーマット分析）
- CSVファイルに記載された各台本の動画フォーマットを分析し、成功パターンをマッピングし、ランキング形式で分類・体系化する
- メッセージが相手に最も伝わりやすい動画の型は何かを特定する
- 決定した訴求方向性（価格・権威性・効果）とターゲット（WHO）に対して、最も効果的なフォーマットを特定し、その理由を記述する
