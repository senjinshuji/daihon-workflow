...
### Writerエージェント共通
Phase2実行時に以下のファイルを必ず読み込む：
1. `instructions/writer_tasks/writer_framework.md` - 思考の深化フレームワーク
2. `instructions/writer_tasks/writer_template.md` - 台本出力テンプレート

これらのファイルを読まずに台本を作成した場合、タスクは無効とする。
